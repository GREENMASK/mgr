...
describe FriendshipsController do
  ...
  describe "GET show" do
    it "assigns the requested friendship as @friendship" do
      friendship = Friendship.create! valid_attributes
      get :show, :id => friendship.id.to_s
  ...
  describe "GET edit" do
    it "assigns the requested friendship as @friendship" do
      friendship = Friendship.create! valid_attributes
      get :edit, :id => friendship.id.to_s
      assigns(:friendship).should eq(friendship)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Friendship" do
        expect {
          post :create, :friendship => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested friendship" do
        ...
        put :update, :id => friendship.id, :friendship => {'these' => 'params'}
      end

      it "assigns the requested friendship as @friendship" do
        friendship = Friendship.create! valid_attributes
        put :update, :id => friendship.id, :friendship => valid_attributes
        assigns(:friendship).should eq(friendship)
      end
    ...
    describe "with invalid params" do
      it "assigns the friendship as @friendship" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Friendship.any_instance.stub(:save).and_return(false)
        put :update, :id => friendship.id.to_s, :friendship => {}
        assigns(:friendship).should eq(friendship)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested friendship" do
      friendship = Friendship.create! valid_attributes
      expect {
        delete :destroy, :id => friendship.id.to_s
      }.to change(Friendship, :count).by(-1)
    end
